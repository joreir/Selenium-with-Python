...
class RegisterNewUser(unittest.TestCase):
    ...
    def  test_new_user(self):
        ...
        midle_name = driver.find_element_by_id('middlename')
        last_name = driver.find_element_by_id('lastname')
        email_address = driver.find_element_by_id('email_address')
        news_letter_subscripcion = driver.find_element_by_id('is_subscribed')
        ...
        and news_letter_subscripcion.is_enabled()
        ...
        email_address.send_keys('Testing.com')
